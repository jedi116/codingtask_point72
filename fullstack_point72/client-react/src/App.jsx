...
function App({ history }) {
  return (
    <div className='min-h-screen bg-gray-700 text-gray-900 flex justify-center'>
            <ToastContainer />
      <div className='max-w-screen-xl m-0 sm:m-20 bg-indigo-400 shadow sm:rounded-lg flex justify-center flex-1'>
        <div className='lg:w-1/2 xl:w-8/12 p-6 sm:p-12'>
          <div className='mt-12 flex flex-col items-center'>
            <h1 className='text-2xl xl:text-2xl font-extrabold  text-center '>
               Authentication App with Email ,  Admin and regular roles,
            ...
            <div className='w-full flex-1 mt-8 text-indigo-500'>
              ...
              <div className='mx-auto max-w-xs relative '>
                ...
                <Link
                  to='/user/list'
                  className='mt-5 tracking-wide font-semibold bg-green-600 text-gray-100 w-full py-4 rounded-lg hover:bg-orange-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none'
                >
                  <i className='fas fa-sign-in-alt  w-6  -ml-2' />
                  <span className='ml-3'>Get User List</span>
                </Link>
                <button
                  onClick={() => {
                    signout(() => {
